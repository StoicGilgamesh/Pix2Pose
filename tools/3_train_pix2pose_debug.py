...
# lr_schedule=[1E-5,1E-5,1E-5,1E-5,1E-5,
#                 1E-5,1E-5,1E-5,1E-5,1E-6,
...
#    np.save("/RoadmapWithStefan/Pix2Pose/NAN2/X_src_"+str(batch_counter)+".npy",X_src)
#    np.save("/RoadmapWithStefan/Pix2Pose/NAN2/X_tgt_"+str(batch_counter)+".npy",X_tgt)
#    np.save("/RoadmapWithStefan/Pix2Pose/NAN2/disc_tgt_"+str(batch_counter)+".npy",disc_tgt)
#    np.save("/RoadmapWithStefan/Pix2Pose/NAN2/prob_gt_"+str(batch_counter)+".npy",prob_gt)
    
#    if math.isnan(np.mean(np.array(recont_losses))):
#        np.save("/RoadmapWithStefan/Pix2Pose/possible_nan2/X_src.npy",X_src)
#        np.save("/RoadmapWithStefan/Pix2Pose/possible_nan2/X_tgt.npy",X_tgt)
#        np.save("/RoadmapWithStefan/Pix2Pose/possible_nan2/disc_tgt.npy",disc_tgt)
#        np.save("/RoadmapWithStefan/Pix2Pose/possible_nan2/prob_gt.npy",prob_gt)
#        break
