...
if detect_type=='rcnn':
    ...
    def get_rcnn_detection(image_t,model):
        ...
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/rois"+".npy",rois)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/obj_orders"+".npy",obj_orders)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/obj_ids"+".npy",obj_ids)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/scores"+".npy",scores)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/masks"+".npy",masks)
...
for scene_id,im_id,obj_id_targets,inst_counts in target_list:
    ...
    for r_id,roi in enumerate(rois):
        ...
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/img_pred_"+str(r_id)+".npy",img_pred)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/mask_pred_"+str(r_id)+".npy",mask_pred)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/rot_pred_"+str(r_id)+".npy",rot_pred)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/tra_pred_"+str(r_id)+".npy",tra_pred)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/frac_inlier_"+str(r_id)+".npy",frac_inlier)
        np.save("/RoadmapWithStefan/Pix2Pose/DEBUG/bbox_t_"+str(r_id)+".npy",bbox_t)
