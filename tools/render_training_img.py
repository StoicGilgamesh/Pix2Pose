...
# #HB, ITODD -> T-LESS
# ref_gt =inout.load_scene_gt(os.path.join("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000","scene_gt.json"))
# ref_camera=inout.load_scene_camera(os.path.join("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000","scene_camera.json"))
...
# bop_dir,source_dir,model_plys,model_info,model_ids,rgb_files,depth_files,mask_files,gts,cam_param_global = bop_io.get_dataset('lmo',train=True)

cfg = inout.load_json("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/cfg/cfg_bop2019_test.json")
ref_gt =inout.load_scene_gt(os.path.join("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000","scene_gt.json"))
ref_camera=inout.load_scene_camera(os.path.join("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000","scene_camera.json"))
#bop_dir,source_dir,model_plys,model_info,model_ids,rgb_files,depth_files,mask_files,gts,cam_param_global = bop_io.get_dataset('hb',train=True)
#bop_dir,source_dir,model_plys,model_info,model_ids,rgb_files,depth_files,mask_files,gts,cam_param_global = bop_io.get_dataset('itodd',train=True)
bop_dir,source_dir,model_plys,model_info,model_ids,rgb_files,depth_files,mask_files,gts,cam_param_global = bop_io.get_dataset(cfg,'lmo',train=True)
...
for i in range(len(model_plys)):
    ...
    for im_id in range(len(ref_gt)):
        ...
        tra = ref_gt[im_id][0]['cam_t_m2c']/10000
        # tra = ref_gt[im_id][0]['cam_t_m2c']
