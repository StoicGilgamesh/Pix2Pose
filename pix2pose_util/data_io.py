...
class data_generator():
    ...
    def get_patch_pair(self,v_id,batch_count):
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/p_xyz.npy", p_xyz)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/real_img.npy", real_img)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/back_img.npy", back_img)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/p_back_img.npy", p_back_img) #### PATCH CROP FROM COCO
        # img_augmented[np.invert(p_mask_no_occ)]=p_back_img[np.invert(p_mask_no_occ)]
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/img_augmented.npy", img_augmented) #### SMALL CROP PATCHED ON COCO


        # image_ref = np.copy(back_img)
        # image_ref[v_ref:v_ref+p_height,u_ref:u_ref+p_width]=img_augmented
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/image_ref.npy", image_ref) #### PATCHED ON FULL COCO IMG


        # xyz = np.ones((image_ref.shape[0],image_ref.shape[1],3))*[0.5,0.5,0.5]
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/xyz_npOnes.npy", xyz)
        # xyz[v_ref:v_ref+p_height,u_ref:u_ref+p_width]=p_xyz
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/xyz.npy", xyz) #### IMG FULL OF 0.5's WITH UV MODEL IN COCO IMG LOCATION AS IN IMAGE_REF
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/p_mask_no_occ.npy", p_mask_no_occ)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/mask_no_occ.npy", mask_no_occ) #### MASK IMG WITH NO OCCLUSIONS IN COCO IMG LOCATION AS IN IMAGE_REF
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/bbox.npy", bbox)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/base_image.npy", base_image)
        # mask_image = np.zeros((v2-v1,u2-u1))
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/mask_image.npy", mask_image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/tgt_image.npy", tgt_image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/image___mask_no_occ.npy", image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/image___boundary_full.npy", image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/image_no_mask_zero.npy", image_no_mask_zero)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/base_image___rand_flip_rot.npy", base_image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/c_img.npy", c_img)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/tgt_image___rand_flip_rot.npy", tgt_image)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/mask_no_occ_ori.npy", mask_no_occ_ori)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/mask_image___rand_flip_rot.npy", mask_image)

        #rotate -15 to 15 degree
        r_angle = random.random()*30-15
        base_image = rotate(img_augmented, r_angle,mode='reflect')
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/base_image___rot_15.npy", base_image)
        tgt_image =  rotate(p_xyz, r_angle,mode='reflect')
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/tgt_image___rot_15.npy", tgt_image)

        mask_area_crop = rotate(p_mask_no_occ.astype(np.float),r_angle)
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/mask_area_crop___rot_15.npy", mask_area_crop)
    ...
    #     u_ref =int(random.random()*u_limit+10)
        ...
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/xyz_npOnes.npy", xyz)
        # xyz[v_ref:v_ref+p_height,u_ref:u_ref+p_width]=p_xyz
        # np.save("/home/stoic_gilgamesh/PhD/RoadmapWithStefan/Pix2Pose/dataset/lmo/train/000000/xyz.npy", image_ref) #### IMG FULL OF 0.5's WITH UV MODEL IN COCO IMG LOCATION AS IN IMAGE_REF
